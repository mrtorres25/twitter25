...
def index(request):
    return render(request, 'geosearch/index.html', {'errorcode':-1,'message':"Introduzca el texto a buscar",'languages':languages})

@login_required(login_url='/login/')
def get_geosearch(request):
    ...
    return render(request, 'geosearch/index.html', context)
