...
class TestSearchEnglish(unittest.TestCase):
    ...
    def test_search_english(self):
        ...
        self.assertEqual(u"Se ha realizado correctamente su busqueda de: \"Renfe\" ---- Idioma seleccionado: En ---- País seleccionado: Cualquiera", driver.find_element_by_css_selector("div.alert.alert-success").text)
